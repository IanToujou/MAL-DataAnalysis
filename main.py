...
# Biggest booba size
top_waifu_boobas = waifu_data.sort_values(by="bust", ascending=False)
top_waifu_boobas = top_waifu_boobas[top_waifu_boobas.bust < 1000].head(10)
top_waifu_boobas.plot(x="name", y="bust", kind="bar", rot=30, fontsize=12, color="blue")
plt.show()

# Most popular waifus
top_waifus = waifu_data.sort_values(by="likes", ascending=False)
top_waifus = top_waifus.head(10)
top_waifus.plot(x="name", y="likes", kind="bar", rot=30, fontsize=12, color="aqua")
plt.show()
...
most_episodes_cleaned = most_episodes.head(5)
